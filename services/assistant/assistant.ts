...
export const createAssistant = async () => {
  ...
  const assistant = await openai.beta.assistants.create({
    instructions,
    name: 'Home Renovation Planning Assistant',
    model: 'gpt-4o',
...
function getInstructions() {
  let instructions = `You are an AI agent that helps people plan home renovations.
  Your goal is to help the user plan their home renovation projects.
  Ask them questions and help them plan their projects
  You have access to functions that can help you save and retrieve projects.`
  return instructions
}
