...
export class AssistantStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: AssistantProps) {
    ...
    // DyanmoDB table
    const assistantsTable = new dynamodb.Table(this, 'AssistantsTable2', {
      partitionKey: { name: 'UserId', type: dynamodb.AttributeType.STRING },
      sortKey: { name: 'Id', type: dynamodb.AttributeType.STRING },
      billingMode: dynamodb.BillingMode.PAY_PER_REQUEST,
      removalPolicy: cdk.RemovalPolicy.RETAIN
    })
    const chatSessionsTable = new dynamodb.Table(this, 'ChatSessionsTable2', {
      partitionKey: { name: 'Id', type: dynamodb.AttributeType.STRING },
      billingMode: dynamodb.BillingMode.PAY_PER_REQUEST,
      removalPolicy: cdk.RemovalPolicy.DESTROY
    })
    const locksTable = new dynamodb.Table(this, 'LocksTable2', {
      partitionKey: { name: 'Id', type: dynamodb.AttributeType.STRING },
      billingMode: dynamodb.BillingMode.PAY_PER_REQUEST,
      removalPolicy: cdk.RemovalPolicy.DESTROY
    })
